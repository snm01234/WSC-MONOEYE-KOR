...
- 메인 TIP: `monoeye_ko_expanded.wsc` · SHA-256 `c7bb4b5c936653888062f2389351c586fc483dedacdba209918b327e440e2131`

## 패치

- 파일: `monoeye_ko_expanded_v1.2.xdelta`
...
2. Original file = 합법적으로 소유한 일본판 원본 `.wsc`, XDelta patch = `monoeye_ko_expanded_v1.2.xdelta`, Output = 새 16 MiB `.wsc`
3. 결과 SHA-256이 `c7bb4b5c936653888062f2389351c586fc483dedacdba209918b327e440e2131`인지 확인
...
```bash
python tools/apply_main_tip_xdelta.py --original "SD Gundam G Generation Mono-Eye Gundams.wsc" --xdelta out/dist/monoeye_ko_expanded_v1.2.xdelta --out out/dist/monoeye_ko_from_xdelta.wsc
```

또는:

```bash
xdelta3 -d -f -s "SD Gundam G Generation Mono-Eye Gundams.wsc" out/dist/monoeye_ko_expanded_v1.2.xdelta out/dist/monoeye_ko_from_xdelta.wsc
```
