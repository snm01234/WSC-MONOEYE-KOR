...
- 메인 TIP: `monoeye_ko_expanded.wsc` · SHA-256 `d1806d8e3d14b1b31246caf745d6068022a7ee80492bf8d2485fa6458882e7fb`

## 패치

- 파일: `monoeye_ko_expanded_v1.4.0.xdelta`
...
2. Original file = 합법적으로 소유한 일본판 원본 `.wsc`, XDelta patch = `monoeye_ko_expanded_v1.4.0.xdelta`, Output = 새 16 MiB `.wsc`
3. 결과 SHA-256이 `d1806d8e3d14b1b31246caf745d6068022a7ee80492bf8d2485fa6458882e7fb`인지 확인
...
```bash
python tools/apply_main_tip_xdelta.py --original "SD Gundam G Generation Mono-Eye Gundams.wsc" --xdelta out/dist/monoeye_ko_expanded_v1.4.0.xdelta --out out/dist/monoeye_ko_from_xdelta.wsc
```

또는:

```bash
xdelta3 -d -f -s "SD Gundam G Generation Mono-Eye Gundams.wsc" out/dist/monoeye_ko_expanded_v1.4.0.xdelta out/dist/monoeye_ko_from_xdelta.wsc
```
