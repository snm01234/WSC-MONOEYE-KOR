...
- [ ] `out/dist/SHA256SUMS_v1.1.txt`의 해시를 갱신했다.

현재 기준:

- 릴리스: **v1.1** · 기준 버전 v1.0.1
- 합법적으로 소유한 일본판 원본 ROM: `376E4C6B4B81CC3A7DCEB15DC4B7D0AF04D3E6C8B81E8572569C39D3394870A0`
- 메인TIP: `F62F14D15F3D76AD2EB33E2B55531AB4781D230CB63BCC2348BBD703D8C39BE3`
- xdelta: `F114AC45D2EFAD024537C452FD5924D972C02AC8F92BB7BE5C06456EB6E6C8C4`
- xdelta 크기: `1,602,926` bytes
- 2026-08-16 재검증: 원본→xdelta→메인TIP round-trip PASS, runtime contract hard/review 0, 전역 20셀/구조 감사 PASS
...
- [ ] `out/dist/monoeye_ko_expanded_v1.1.xdelta`
- [ ] `out/dist/monoeye_ko_expanded_v1.1_xdelta.json`
- [ ] `out/dist/SHA256SUMS_v1.1.txt`
...
- [ ] README의 입력/출력 SHA가 `SHA256SUMS_v1.1.txt`와 일치한다.
