#!/usr/bin/env python3
"""Build Garrod/Loran/Guen literal retranslation candidate from curated data.

Legacy quality/sheet Korean is forensic only. Every replacement is validated
against Japanese text decoded from the pristine ROM, then installed by either:
  - same-extent native stock restore (when tip slots already hold correct KO)
  - retargeting an existing E5 18 five-bank portal
  - installing a new E5 18 portal into a bare same-extent body
"""
...
SPEC = ROOT / "data/garrod_loran_guen_literal_retranslation_ko.json"
TBL_PATH = ROOT / "out/patch/hangul_patch_pad3.tbl"
OUT_ROM = ROOT / "out/patch/garrod_loran_guen_literal_retranslation_candidate.wsc"
OUT_SAVE = ROOT / "sram/garrod_loran_guen_literal_retranslation_candidate.sav"
REPORT = ROOT / "out/patch/garrod_loran_guen_literal_retranslation_candidate_report.json"
...
def main() -> int:
    ...
    report = {
        "schema_version": 1,
        "generated_by": "tools/build_garrod_loran_guen_literal_retranslation_candidate.py",
