#!/usr/bin/env python3
"""Parent-delta regression summary for the all-remaining character candidate."""
...
OUT = ROOT / "out/patch/encyclopedia_character_all_remaining_regression_audit.json"

PARENT = ROOT / "out/patch/monoeye_ko_expanded.wsc"
CANDIDATE = ROOT / "out/patch/encyclopedia_character_all_remaining_candidate.wsc"
STATIC = ROOT / "out/patch/encyclopedia_character_all_remaining_candidate_audit.json"
...
STRUCTURE_CANDIDATE = ROOT / "out/patch/encyclopedia_character_all_remaining_structure.json"
FALSE_PARENT = ROOT / "out/patch/encyclopedia_character_five_bank_batch02_false_segptr_parent.json"
FALSE_CANDIDATE = ROOT / "out/patch/encyclopedia_character_all_remaining_false_segptr.json"
...
def main() -> int:
    ...
    checks = {
        ...
        "residual_candidate_zero": int(candidate_counts.get("actionable_records", -1)) == 0,
        "residual_exactly_603_removed": (
    ...
    report = {
        "schema_version": 1,
        "generated_by": "tools/audit_encyclopedia_character_all_remaining_regressions.py",
        "read_only": True,
        "ok": ok,
    ...
    if not ok:
        raise RegressionError("all-remaining character regression audit failed")
    return 0
